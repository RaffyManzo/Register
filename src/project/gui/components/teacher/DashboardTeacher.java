...
public class DashboardTeacher extends RoundedPanel {
    ...
    public DashboardTeacher(GridBagLayout gbl, String selectedClassId) {
        ...
        JPanel buttonsPan = new JPanel(new GridLayout(2, 1, 20, 20));
        buttonsPan.setBackground(new Color(229, 229, 229));
        ...
        JPanel avgClassContainer = new RoundedPanel(new BorderLayout(5,5));
        double classAvg = new GradeDAO().getClassAvg(teacher.getMateria(), selectedClassId);

        avgClassPan = new AvgCircle(classAvg*10);

        avgClassContainer.add(avgClassPan, BorderLayout.CENTER);
        gb.gridy = 1;
        gb.gridx = 1;
        gb.weighty = 0.7;
        gb.weightx = 1;
